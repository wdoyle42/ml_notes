...
The model has now been fit to 25 versions of the training data. Let's look ath metrics using `collect_metrics`.
```{r}
...
```{r}
lasso_grid<-grid_regular(parameters(ames_tune_fit) ,levels=10)
```
